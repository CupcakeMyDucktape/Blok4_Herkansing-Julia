...
public class WASDWaveFriendlyPlayerController : MonoBehaviour {
    ...
    public void Awake()
    {
        ...
        StartRotation = Self.localRotation;
        Camera = Camera.main;
    }
    ...
    public void FixedUpdate()
    {
        ...
        //Rotational Force
        Rigidbody.AddForceAtPosition(steer * transform.right * SteerPower / 100f, Self.position);
        ...
        Self.SetPositionAndRotation(Self.position, transform.rotation * StartRotation * Quaternion.Euler(0, 30f * steer, 0));
